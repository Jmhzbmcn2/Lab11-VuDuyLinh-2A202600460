        ...
        *,
        ...
        if not filter_result["safe"]:
            llm_response.content = types.Content(
                role="model", parts=[types.Part.from_text(text=filter_result["redacted"])]
            )
        ...
        if self.use_llm_judge:
            ...
            if not safety_result["safe"]:
                llm_response.content = types.Content(
                    role="model",
                    parts=[types.Part.from_text(text="[BLOCKED BY JUDGE] The generated response was classified as unsafe.")]
                )
